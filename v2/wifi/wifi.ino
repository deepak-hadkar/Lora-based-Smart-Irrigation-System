...
void updateFirebase()
{
    ...
    if (Firebase.getInt(firebaseData, ("user/" + uid + "/actuator/Control")))
    {
        valveControl = firebaseData.intData();
    }
    if (Firebase.getInt(firebaseData, ("user/" + uid + "/sensor/highThreshold")))
    {
        highThreshold = firebaseData.intData();
    }
    if (Firebase.getInt(firebaseData, ("user/" + uid + "/actuator/lowThreshold")))
    {
        lowThreshold = firebaseData.intData();
    }
