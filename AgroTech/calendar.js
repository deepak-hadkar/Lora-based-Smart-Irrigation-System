var cal = {
  ...
  init : () => {
    ...
    cal.hfStime = document.getElementById("event-start-time");
    cal.hfEtime = document.getElementById("event-end-time");
  ...
  // (F) SAVE EVENT
   save : () => {
    cal.data[cal.sDay] = 'Time: '+ cal.hfStime.value + '-' +'  ' + cal.hfEtime.value+ '\n' +'Details: ' + '   ' + cal.hfTxt.value;
